...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    name: "Nguyen Quoc Huy Pham",
    image: assets.profile_pic,
    email: "pngqhuyuidev@gmail.com",
    phone: "+8 79 659 2839",
    address: {
      line1: "11 Nguyen Dinh Chieu",
      line2: "Dakao Ward, District 1, Ho Chi Minh City",
    },
    gender: "Male",
    dob: "2004-06-22",
  });
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <hr  className="bg-zinc-00 h-[1px] border-none"/>
      <div>
